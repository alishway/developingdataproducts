...
levels(mtcars$vs) <- c("s", "v")
mtcars$cyl <- factor(mtcars$cyl)
mtcars$gear <- factor(mtcars$gear)
mtcars$carb <- factor(mtcars$carb)
ggplot(mtcars, aes(factor(cyl), mpg))  + geom_boxplot(aes(fill = cyl))  + xlab("Number of Cylinders") + ylab("Miles/gallon")+ ggtitle("Miles/gallon versus number of Cylinders")
```
